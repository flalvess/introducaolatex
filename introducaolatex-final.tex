...
\setmainfont[Numbers=OldStyle]{Bulmer MT Std}
\setsansfont{Profile}
\setmonofont[Scale=MatchLowercase]{Candara}
\usepackage{hyperref}
...
\phantom{}
\vfill
Este texto foi composto e adaptado (uma tradução livre com acréscimos) de: \url{http://en.wikibooks.org/wiki/LaTeX/}. O tipo usado foi \textit{Jannon Text Moderne}, uma recriação dos tipos de Jean Jannon do século \textsc{XVII}, para texto, e \textsf{Profile}, de Martin Wenzel (1999), para títulos. A classe utilizada foi \KOMAScript{}, de Frank Neukam, Markus Kohm \& Axel Kielhorn.
