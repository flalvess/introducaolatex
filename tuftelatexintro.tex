\documentclass[a4paper,nols,bidi,nohyper]{tufte-book}
\usepackage{amssymb}
\usepackage{fontspec}
...
\phantom{}
\vfill
Este texto foi composto e adaptado (uma tradução livre com acréscimos) de: \url{http://en.wikibooks.org/wiki/LaTeX/}. O tipo usado foi \textbf{Bulmer}, criado em 1792 por William Martin (1757–1830).. A classe utilizada foi \textit{Tufte-\LaTeX}.
